...
fun BluromaticScreenContent(
    ...
    var blurredImageUri by remember { mutableStateOf<String?>(null) }
    ...
    Column(modifier = modifier) {
        ...
        BlurActions(
            ...
            onStartClick = {
                ...
                // 假設 applyBlur 操作會更新 blurUiState 並設置 outputUri
                blurredImageUri = blurUiState.toString()//.outputUri
            },
            onSeeFileClick = {
                blurredImageUri?.let { uri ->
...
@Composable
fun SinglePhotoPicker(onImageUri: (Uri?) -> Unit) {
    var uri by remember {
